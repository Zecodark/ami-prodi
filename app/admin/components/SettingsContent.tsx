    ...
    <div className="max-w-2xl">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {/* Untuk verifikasi password lama jika diperlukan, disini disederhanakan hanya ubah */}
          ...
          <div className="mt-2">
            <button 
              ...
              className="px-6 py-2.5 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 text-white text-sm font-medium transition-all hover:shadow-lg hover:shadow-indigo-500/20 disabled:opacity-50"
            >
